...
%                             end
    ...
    if mod(mm, 2) == 1  %if subject number is odd 
        run_array = [1 2 6 7 10 11 12]; % run numbers for HOW trials for odd subjs
    else
        run_array = [3 4 5 8 9 13 14]; % run numbers for HOW trials for even subjs
