...
'YOU_STOR_06','YOU_STOR_07','YOU_STOR_09','YOU_STOR_11','YOU_STOR_12', 'YOU_STOR_13', 'YOU_STOR_14',...
'YOU_STOR_15'};
input_runs = {6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6};
num_conds = 4;

study_path = '/younglab/studies/STOR/';
model_path = '/results/STOR_results_unsmoothednormed';
outputfolder = '/younglab/studies/STOR/STOR_MVPA';
outputname = 'test';
...
roiFiles = {'DMPFC_tom','MMPFC_tom'}; %it will wildcard either side of this, so make sure
...
experiments=struct(...
    ...
    'pwd1','/younglab/studies/STOR/',...   % folder with participants %%%%need to change this
