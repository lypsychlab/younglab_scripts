...
partition_names={'Even_','Odd_'};
 ...
 condition_names_all={{'int-phys-harm','acc-phys-harm','int-psy-harm','acc-psy-harm'}%,... XXXcheck shapes and stop here
...
for i=1:length(roiFiles)
    roin = roiFiles{i};
    roinum = i;
    savedirectory = '/younglab/studies/DIS_MVPA/MVPA_replicate/MVPA_DISWcontrol_smoothed_normed_n23_nondirectional_joriemodel';
    mkdir(savedirectory);
