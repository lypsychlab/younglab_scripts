function younglab_dicom_convert_MOR4 (varargin)
%
...
% converted and subjects are given by the identifier 'SAX'
...
EXPERIMENT_ROOT_DIR = '/home3/younglw';
...
%     delete('*')
    ...
    delete([anatdir '/*']);
    sfiles = dir([dicom_dir '/s0-0002*img']);
