function DIS_Combcond(subjID)

cd /home/abrown/Desktop/DIS/behavioural
...
cd /home/abrown/Desktop/DIS/behavioural
    save([subjID '.DIS.domain.' num2str(acq) '.mat' ],'acq','RT','key','design','design_run','items','items_run','ips', 'con_info', 'spm_inputs', 'experimentDur', 'subjID');
...
cd /home/abrown/Desktop/DIS/behavioural
    save([subjID '.DIS.domint.' num2str(acq) '.mat' ],'acq','RT','key','design','design_run','items','items_run','ips', 'con_info', 'spm_inputs', 'experimentDur', 'subjID');
    clear acq RT key design design_run item items_run ips con_info spm_inputs experimentDur xx;
