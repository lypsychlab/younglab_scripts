...
input_id = {'YOU_TRAG_03','YOU_TRAG_05','YOU_TRAG_06','YOU_TRAG_08','YOU_TRAG_09',...
'YOU_TRAG_10','YOU_TRAG_11','YOU_TRAG_12','YOU_TRAG_13','YOU_TRAG_14','YOU_TRAG_15','YOU_TRAG_16', 'YOU_TRAG_19', 'YOU_TRAG_20',...
'YOU_TRAG_21', 'YOU_TRAG_22', 'YOU_TRAG_23', 'YOU_TRAG_24'};
input_runs = {6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6};
num_conds = 4;

study_path = '/younglab/studies/TRAG/';
model_path = '/results/TRAGend_results_normed';
outputfolder = '/younglab/studies/TRAG/TRAG_MVPA';
outputname = 'test';

condition_names = {'TABTRA','TAB', 'TRATAB', 'TRA'}; %These should match the order that they are listed in spm_input in the behavioural files.
roiFiles = {'PC_tom','DMPFC_tom', 'VMPFC_tom', 'RTPJ_tom', 'LTPJ_tom', 'RSTS_tom','LSTS_tom'}; %it will wildcard either side of this, so make sure
%that these uniquely identify a ROI. It is looking for an image file.
contrast_names = {'TABTRA_v_TAB', 'TABTRA_v_TRATAB', 'TABTRA_v_TRA', 'TAB_v_TRATAB', 'TAB_v_TRA', 'TRATAB_v_TRA'};
