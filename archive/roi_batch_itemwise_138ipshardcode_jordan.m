...
%        wronglist = offlist([5 10]);
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %The baseline is the first 6 TRs, omitting the first 2, averaged
        %across all runs. I'm hardcoding here because the ips is set to 139
        %when it should be 138. This has the consequence of making the
        %baseline take the LAST TR of each run and pulling that into the
        %average.
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
