    ...
    for part1=1:numel(partition_names),
        for part2=[1:part1-1,part1+1:numel(partition_names)],
            ...
            for ncondition=1:numel(condition_names),
                ...
                %% AB 2/11/15- below, the subjects are identified one by one (is this maybe where the issue with weird subject skipping in the gui comes from?) 
...
disp(sprintf('\nnumber of elements: \n acc_n: %d \n acc_mean: %d \n acc_stderr: %d \n',numel(acc_n), numel(acc_mean), numel(acc_stderr)));

disp(sprintf('\n acc_n: %d \n acc_mean: %2.5g \n acc_stderr: %2.5g \n',acc_n, acc_mean,acc_stderr));
...
disp(sprintf('\nnumber of elements: \n acc_T: %d \n acc_p: %d \n acc_d: %d \n',numel(acc_T),numel(acc_p),numel(acc_d)));
