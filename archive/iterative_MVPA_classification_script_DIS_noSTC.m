...
'SAX_DIS_08','SAX_DIS_09','SAX_DIS_10','SAX_DIS_11','SAX_DIS_12','SAX_DIS_13','SAX_DIS_27','SAX_DIS_28',...
'SAX_DIS_32','SAX_DIS_34','SAX_DIS_38', 'SAX_DIS_40', 'SAX_DIS_41', 'SAX_DIS_42','SAX_DIS_45'};
input_runs = {6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6,6,6,6,6,6};
num_conds = 4;
...
outputname = 'domintMVPA20_nopreproc_nonparametric_smoothed_normed_2mm_noSTC';
...
FisherTransform = 'N' %Transform correlation coefficents to follow normal distribution, using atanh().
preprocYN = 'N' %this means preprocessing the BOLD data, either by centering voxels or runs.

%if you are preprocessing, one of these should be set to Y, and the other
%to N.
    preproc_voxelwise = 'N' %Y/N
    preproc_runwise = 'N' %Y/N

%Same thing here, one should be Y, one should be no.
    preproc_zscore = 'N' %Y/N
    preproc_cocktail = 'N' %Y/N This means just subtracting the mean, and not dividing by S.D.
