function subjIDs = makeIDs_fullpath(studystring, subjectname, numlist)
...
for num=numlist
    if num<10
	    subjIDs{i} = ['/home/younglw/' studystring '/SAX_' subjectname '_0' num2str(num)];
    else
        subjIDs{i} = ['/home/younglw/' studystring '/SAX_' subjectname '_' num2str(num)];
    end
	i=i+1;
end