...
% Last edited by Brendan Gaesser 12/8/2014.

% I am working on editing script in order to run SPM for concatenated runs 
% (i.e., all runs combined serially into a single run).
