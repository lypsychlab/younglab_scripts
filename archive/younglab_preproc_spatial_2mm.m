function younglab_preproc_spatial_2mm (varargin)
%
...
%defaults = spm_defaults_alek; % uses voxel size of 2x2x2
defaults = spm_defaults_MVPA; % also uses voxel size of 2x2x2, smoothing kernel 5mm
