function DIS_mvpa_ab()

% last edited to replicate DIS using Jorie's modeling 
...
experiments=struct(...
    ...
    'data',{{'SAX_DIS_03','SAX_DIS_04','SAX_DIS_05','SAX_DIS_06','SAX_DIS_07',...
'SAX_DIS_08','SAX_DIS_09','SAX_DIS_10','SAX_DIS_11','SAX_DIS_12','SAX_DIS_13','SAX_DIS_14','SAX_DIS_27','SAX_DIS_28',...
'SAX_DIS_32','SAX_DIS_34','SAX_DIS_40','SAX_DIS_41','SAX_DIS_42','SAX_DIS_43','SAX_DIS_45','SAX_DIS_46'}});
...
partition_names={'Even ','Odd '};
 ...
 condition_names_all={{'accidental harm','intentional harm'}%,... XXXcheck shapes and stop here
...
for i=1:length(roiFiles)
    roin = roiFiles{i};
    roinum = i;
    savedirectory = '/younglab/studies/DIS_MVPA/MVPA_replicate/MVPA_jorie_model_smoothed_normed_n22_nondirectional_noSTC';
    mkdir(savedirectory);
