function younglab_create_contrast(name, conditions,values, sname, tname, rname, varargin)

% younglab_create_contrasts(contrast name, {conditions}, [values], sname, tname, rname)
...
% Example:
%
% younglab_create_contrast('Even music runs vs. Odd language runs',{'[2468]*mus*','[1357]*lang*'},[1 -1],'LANG','KAN_LANG_*','Lang_results_normed')
% will match 
% Sn(2) music*bf(1)
% Sn(4) music*bf(1)
% Sn(6) music*bf(1)
...
destsubj = resultsDirFinderator(sname,tname,rname);
doassoc = 0;
