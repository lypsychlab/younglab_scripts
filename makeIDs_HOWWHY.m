function subjIDs = makeIDs_HOWWHY(studyfolder,studystring,numlist)
...
for num=numlist
    if num<10
	    subjIDs{i} = ['/home/younglw/lab/' studyfolder '/YOU_' studystring '_0' num2str(num)];
    else
        subjIDs{i} = ['/home/younglw/lab/' studyfolder '/YOU_' studystring '_' num2str(num)];
    end
	i=i+1;
end