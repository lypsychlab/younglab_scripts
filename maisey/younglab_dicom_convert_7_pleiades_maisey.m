function younglab_dicom_convert_7_pleiades(varargin)
%
...
%     delete('*')
    ...
    eval(sprintf('!unpacksdcmdir -src %s -targ %s -scanonly %s',dicom_dir,unpack_dir,summary));
    keyboard;
    ...
    delete([anatdir '/*']);
    sfiles = dir([dicom_dir '/s0-0007*img']);
