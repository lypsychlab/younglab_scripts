...
%-----------------------------------------------------------------------
function DIS_itemwise_job_pleiades(tagnames)
...
% end 
% repmat(['/home/younglw/lab/server/englewood/mnt/englewood/data/PSYCH-PHYS/' char(subjIDs) '/results/DIS_results_itemwise_normed/RSA_searchlight_regress_' tagnames{t} '.img,1']],39,1)
