function spm_inputs_dumb(root_dir,study,subjs,runs,taskname1,t1,taskname2,t2)
...
% - taskname: name by which to identify behavioral .mats
	...
	for s=1:length(subjs)
		try
			...
			for r=1:runs
				disp(['Run ' num2str(r)])
					fname=[subjs{s} '.' taskname1 '.' num2str(t1(r)) '.mat'];
					f=load(fname);
					...
					save([subjs{s} '.' taskname2 '.' num2str(t2(r)) '.mat'],'spm_inputs_itemwise','-append');
					clear f fname;
