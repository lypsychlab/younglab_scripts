function conn_BATCH_firstlevel_PSYCH(study,connmat,firstlevel,run_batch)
%=====================================================================
...
try
    conn_file=load(['conn_' connmat '.mat']);
catch
    sprintf('No .mat file named conn_%s in directory %s',connmat,pwd)
    return
end
