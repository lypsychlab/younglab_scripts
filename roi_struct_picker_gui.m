...
switch fcn
    ...
    case 'choose'
        ...
        switch plotinfo.roi
            case 1;  plotinfo.roi='RTPJ';  plotinfo.roi_xyz = load('/home/younglw/roi_library/functional/RTPJ_xyz');
            case 2;  plotinfo.roi='LTPJ';  plotinfo.roi_xyz = load('/home/younglw/roi_library/functional/LTPJ_xyz');
            case 3;  plotinfo.roi='RSTS';  plotinfo.roi_xyz = load('/home/younglw/roi_library/functional/RSTS_xyz');
            case 4;  plotinfo.roi='LSTS';  plotinfo.roi_xyz = load('/home/younglw/roi_library/functional/LSTS_xyz');
            case 5;  plotinfo.roi='PC';    plotinfo.roi_xyz = load('/home/younglw/roi_library/functional/PC_xyz');
            case 6;  plotinfo.roi='MMPFC'; plotinfo.roi_xyz = load('/home/younglw/roi_library/functional/MMPFC_xyz');
            case 7;  plotinfo.roi='DMPFC'; plotinfo.roi_xyz = load('/home/younglw/roi_library/functional/DMPFC_xyz');
            case 8;  plotinfo.roi='RIFG';  plotinfo.roi_xyz = load('/home/younglw/roi_library/functional/RIFG_xyz');
            case 9;
                ...
                if strcmp(answer,'ROI Image')
                    ...
                    plotinfo.roi     = t{1};
                    f                = spm_select(1,'mat',['Choose a coordinates file for ' t{1}],'','/home/younglw/roi_library','.*',1);
    ...
    case 'specify'
        ...
        plotinfo.subjects = spm_select(Inf,'dir','Choose subject directories for ROI Picking','','/home/younglw/studies','.*',1);
    ...
    case 'save'
        ...
        saveas(gcf,['/home/younglw/scripts/roi_picker_sessions/sessions-' cmt{1} '-' plotinfo.roi '-' date '.fig'],'fig');
        
    case 'load'
        cur_fig = spm_select(1,'any','Choose subject directories for ROI Picking','','/home/younglw/scripts/roi_picker_sessions','.*',1);
