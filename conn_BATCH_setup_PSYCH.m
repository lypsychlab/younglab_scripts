function filename = conn_BATCH_setup_PSYCH(varargin)
% ================================================
...
%     end
	...
	if default_roi
		...
		BATCH.Setup.rois=make_roi_struct_PSYCH(study,subjIDs,length(sessions{1}),anatomical,chosen_roi); %
	end
