function younglab_model_spm8_itemwise_unsmooth_pleiades(varargin)
...
%     try
        ...
        for task = 1:length(tasks{subj})
            ...
            cd(fullfile(EXPERIMENT_ROOT_DIR,study,'behavioural_pp'));
            behavdata_thistask = dir(sprintf('%s.%s.*.mat',subject{subj},tasks{subj}{task}));
...
function skullStripMaker(study, subj, maskthresh)
    ...
    global mask_over;
    global inStruct;
    directory = ['/home/younglw/server/englewood/DIS_MVPA/' study '/' subj '/3danat/'];
