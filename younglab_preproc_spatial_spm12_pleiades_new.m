function younglab_preproc_spatial_spm12_pleiades (varargin)
%
...
%   ^                         ^               |        
% <001...00n>             <task(s)>          ...   
addpath(genpath('/gsfs0/public/spm/spm12'));
spm fmri
global EXPERIMENT_ROOT_DIR;
EXPERIMENT_ROOT_DIR = '/gsfs0/data/younglw/lab/';
addpath(genpath('/gsfs0/data/younglw/lab/scripts'));
