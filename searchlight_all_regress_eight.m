function searchlight_all_regress_eight(study,subj_tag,resdir,sub_nums,conditions,sph,b1,b2,b3,b4,b5,b6,b7,b8,outtag)
...
% - [searchlight images]: .nii files prepended with "RSA_searchlight_regress", in results dir
	...
	for subj=1:length(subjIDs) %grabbing beta images
	    ...
	    corrs  = zeros(length(greymattermask2),9); 
	    ...
	    for i=1:length(greymattermask2) 
                ...
                corrmap_7(voxel_order2(greymattermask2(i),1),...
	                    voxel_order2(greymattermask2(i),2),...
	                    voxel_order2(greymattermask2(i),3)) = corrs(i,7);
                corrmap_8(voxel_order2(greymattermask2(i),1),...
	                    voxel_order2(greymattermask2(i),2),...
	                    voxel_order2(greymattermask2(i),3)) = corrs(i,8);
                corrmap_9(voxel_order2(greymattermask2(i),1),...
                        voxel_order2(greymattermask2(i),2),...
                        voxel_order2(greymattermask2(i),3)) = corrs(i,9);
	    end
