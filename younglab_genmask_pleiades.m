function younglab_genmask_pleiades(study, subject, normalized)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
root = adir(sprintf('/home/younglw/lab*/%s/%s',study,subject));
if ~iscell(root)
    terror('Could not locate study/subject pair.');
elseif length(root) > 1
    root = adir(sprintf('-t /home/younglw/lab*/%s/%s',study,subject));
    root = root{1};
