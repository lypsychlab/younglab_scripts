function roi_batch_itemwise_mk(subjects,roi_name,task_dir, loc_dir, contrast_num, win_secs, onsetdelay, highpass, meanwin)
            ...
            for c = 1:length(Cond)
                for o = 1:length(Cond(c).onidx)
                    ...
                    %mk for t = 1:window_length+2
                        %disp('printing... \n')
                        %disp(100*(Cond(c).Y_items(o,t) - baseline)/baseline)
