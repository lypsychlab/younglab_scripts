function conn_template_pleiades(study,subj_tag,subj_nums,sessions,tname,analysis_type,roinames,fname)
...
toc; %time to set up
conn_BATCH_setup_pleiades(study, subjs, sessions, an,fname,roinames,'choose_roi','conditions')
toc; %time to complete setup step
conn_BATCH_firstlevel_pleiades(study,fname,{'corr'},0)
toc;
