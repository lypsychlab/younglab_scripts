...
% rnames: 
% 	- cell array of ROI names (e.g. {"RTPJ" "LIFG"});
%  	- to use CONN's atlas ROIs, leave this blank, like so: {}
%
%On/Off Parameters:
%mask_subject:
...
%
%sample call:
%conn_BATCH_setup('RACA',{'YOU_RACA_02' 'YOU_RACA_03'},{[13 15] [15 17]},{'roi'},'ROI_analysis_RTPJ',{'RTPJ'})
%
%=================================================
	...
	if mask_subject 
		...
		BATCH.Setup.voxelmaskfile='/usr/public/spm/spm12/toolbox/OldNorm/brainmask.nii'; 
	end
	...
	if default_roi
		...
		BATCH.Setup.rois=make_roi_struct_pleiades(study,subjIDs,rnames); 
    end
