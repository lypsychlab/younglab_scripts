...
diary(fullfile(experiments.pwd1,'logs',['untitled2_emily_server_' date '.txt']))
...
notes = 'subj  bad';
save(['MVPA_data_purity_plus06_' roin '.mat'],'R','Z','R_wb','Z_wb','Data_part1','Data_part2','notes','stddevs1','stddevs2');
diary off;