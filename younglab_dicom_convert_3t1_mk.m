function younglab_dicom_convert_3t1_mk (varargin)
%
% MODIFICATIONS FOR 3T1 SCANNER:
% - assumes that the MPRAGE scan is the 10th run
%
...
EXPERIMENT_ROOT_DIR = 'gsf0/data/younglw/lab';

addpath(genpath('/usr/public/spm/spm12'));
addpath(genpath('gsf0/data/younglw/lab/scripts'));
...
%     delete('*')
    ...
    delete([anatdir '/*']);
    sfiles = dir([dicom_dir '/s0-0010*nii']);
%     sfiles = dir([dicom_dir '/s*img']);
    ...
    vNav_dir = fullfile(subj_dir,'bold','006');
