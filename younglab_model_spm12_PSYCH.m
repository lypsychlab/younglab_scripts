function younglab_model_spm12_PSYCH(varargin)
...
%     try
        ...
        for task = 1:length(tasks{subj})
            ...
            save(fullfile(EXPERIMENT_ROOT_DIR,'foo.mat'),'boldirs','num_runs');
            ...
            cd(results_string);
            rS1 = pwd; %returns current folder as a string to rS1
			percRetained = freqAnalyze_PSYCH(study, subject{subj}, tasks{subj}{task}, filter_frequency, rS1);
            set(0,'DefaultFigureVisible','Off');
...
%                     try
                        ...
                        [tp,ord] = sort(tp);% vector of timepoints and vector of index positions
...
%                     end
            ...
            for i=1:num_runs
                ...
                elseif length(files{i}) < expected_num_files(i)
                    save(fullfile(EXPERIMENT_ROOT_DIR,'boldirs.mat'),'boldirs','files');
            ...
            save SPM SPM
            pwd_art = pwd; %looks like pwd = the 'results' dir at this point
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
STEPS=[1,1]; %automatically completes both steps below
pwd1 = resDir;
