...
ss=struct(...
	...
	'EffectOfInterest_spm',{repmat(spmfiles,[4,1])},...
	'Localizer_spm',{cat(1,spmfiles,spmfiles)},...
    'EffectOfInterest_contrasts',{{'S','W','J','N'}},...    % contrasts of interest
    'Localizer_contrasts',{{'S-N','W-J'}},...                     % localizer contrast (note: if these contrasts are not orthogonal the toolbox will automatically partition theses contrasts by sessions and perform cross-validation) 
