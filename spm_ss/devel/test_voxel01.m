% example script.
% This script will perform voxel-based subject-specific analyses, using the contrast 'S-N'
% both as localizer and effect of interest contrast (the toolbox will
...
ss=struct(...
    'swd',fullfile(pwd,'test_voxel'),...                          % output directory
    ...
    'type','voxel',...                                      % can be 'GcSS' (for automatically defined ROIs), 'mROI' (for manually defined ROIs), or 'voxel' (for voxel-based analyses)
    'smooth',8,...                                          % (FWHM mm)
