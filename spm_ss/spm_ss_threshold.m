function [thr_p,thr_type,filenames]=spm_ss_threshold(option,spm_data,Ic,Ec,options)
% SPM_SS_THRESHOLD
...
switch(lower(option))
    ...
    case 'subject',
        ...
        if AnyAutomatic
            ...
            MaskFilenames{end+1}=spm_ss_createlocalizermask(spm_data.SPM,Ic,Ec,0,Threshold_type,Threshold_p,options);
        end
