function younglab_model_spm12_sirius_mk(varargin)
%
...
%                     try
                ...
                %mk spm_defaults = spm_get_defaults;
                %mk Oct 2018 spm_defaults = spm_defaults_lily;
                spm_defaults;
...
function skullStripMaker(study, subj, maskthresh)
    ...
    global mask_over;
    global inStruct;
    directory = ['/data/younglw/lab/' study '/' subj '/3danat/'];
