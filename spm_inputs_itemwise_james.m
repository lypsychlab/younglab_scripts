function spm_inputs_itemwise_james(root_dir,study,subjs,runs,taskname1,taskname2)
			...
			for r=1:runs
				disp(['Run ' num2str(r)])
					...
					for it=1:num_items
						...
						spm_inputs_itemwise(it).ons = f.spm_inputs(f.entirety_run(it)).ons;
						spm_inputs_itemwise(it).dur = f.spm_inputs(f.entirety_run(it)).dur;
					end
